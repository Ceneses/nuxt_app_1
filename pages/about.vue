  ...
  <section>
    ...
    <div class="relative mx-auto flex w-full max-w-[1120px] flex-col items-start px-5 py-16 md:px-10 md:py-24 lg:py-32">
      ...
      <div class="lg:max-w-[80%]">
        <h1 class="mb-5 text-4xl font-semibold md:text-8xl lg:mb-8">The Website You Want Without The <span class="bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/6390526ac2a607693620c97b_Rectangle%2010.svg')] bg-cover bg-center bg-no-repeat px-4 text-white">Dev Time</span>.</h1>
      ...
      <div class="flex">
        ...
        <a href="#" class="flex flex-row items-center rounded-xl border border-solid border-[#1353fe] px-6 py-3 font-semibold text-[#1353fe] [box-shadow:rgb(19,_83,_254)_6px_6px]">
